...
from main import capturaDados, carregaArquivo, grafico_cg_at, enzimas_de_restricao, identifica_genes_resistencia, temperatura_melting, graficobarras, reconhece_proteinas
...
botao_proteinas = tk.Button(linha_botoes_3, text="Identifica proteínas", command=lambda: reconhece_proteinas(entrada, resultado) )
botao_proteinas.pack(side=tk.RIGHT, padx=10, pady=10)
